...
dataServiceV3.prototype.bind2form= function(data)
{
	 jo=str2json(data);
	  jo=jo[0];
	  for (prop in jo)
...
//dataServiceV3.prototype
dataServiceV3.prototype.t= function(data)
{
	alert(this.merge_after_goto_url);
}
dataServiceV3.prototype.merge_callback= function(data)
{
	 jo=str2json(data);
	   logx(data);
...
dataServiceV3.prototype.merge=function(metaData,merge_callback_fun)
  {
...
dataServiceV3.prototype.query=function(metaData,merge_callback_fun)
  {
