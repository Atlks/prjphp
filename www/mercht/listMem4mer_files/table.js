 ...
 * @return {Boolean}
 */
function insertRowsc_pttc(obj, k,pttc) {
	var rowsnumber = obj.rows.length;
	var cellsnumber = obj.rows[0].cells.length;
	var now_num = 0;
	 //alert("row:"+rowsnumber+" cel:"+cellsnumber);
	...
	for (var i = 0; i < cellsnumber; i++) {
		...
		if(i!=0){
			if(i==4)
			{
			   cell.innerHTML = '<input id="'+idstr+'" onkeyup="checkVal_tc(this);" name="'+idstr+'" style="width:150px" type="text" value="0" />';
			}
			else
			{
			   cell.innerHTML = '<input id="'+idstr+'" onkeyup="checkVal_tc(this);" name="'+idstr+'" style="width:150px" type="text" value="" />';
			}
		}else{
		   cell.innerHTML = '<input id="'+idstr+'" name="'+idstr+'" type="text" style="width:150px" value="" />';
		}
		//alert(cell.innerHTML);
